...
class login_window:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\bg3.png")

        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        original_frame_image = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\loginbg1.jpg")
        resized_frame_image = original_frame_image.resize((400, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_frame_image)

        original_frame_image1 = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\FFF.png")
        ...
        get_str=Label(self.frame_border,text="Pawan Sharma ",font=("times new roman",10,"bold"),fg="RED",bg='NAVY blue')
    ...
    def login(self):
        if self.txtuser.get() == "" or self.txtpass.get() == "":
            ...
            conn = mysql.connector.connect(host="localhost", user="root", password="Pawan@123", database="sys")
...
class Register:
    def __init__(self, root):
        ...
        #########bg image#####
        self.bg = ImageTk.PhotoImage(file="C:/Users/Pawan Sharma/Football_management_system/football_managmnet _system/DBMS GUI PROJECT/images/qnUbi9.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        #########bg image#####
        self.bg1 = ImageTk.PhotoImage(file=r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\CR7.png")
    ...
    ################## MIAN_FRAME############
        ...
        ########################button
        img=Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\images.jpg")
        ...
        img1=Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\login-png-royalty-free_60202203531a5.png")
...
class AdminWindow:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\leftframe.jpg")
...
class Insert_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\leftframe2.jpg")
        ...
        original_frame_ima = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\matchesdis.jpg")
        ...
        original_frame_ima = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\ranking.jpg")
...
class update_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\update_player.jpg")
        ...
        original_frame_ima = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\update_match.jpg")
        resized_frame_ima = original_frame_ima.resize((300, 425), Image.BICUBIC)
        self.bg2 = ImageTk.PhotoImage(resized_frame_ima)
...
class display_win:
    def __init__(self, root):
        ...
        original_frame_image = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\dis_team.jpg")
        resized_frame_image = original_frame_image.resize((300, 400), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_frame_image)
        ...
        original_frame_ima = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\leftframe2.jpg")
...
class player_info_window:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\UPDATE PLAYER.jpg")
...
class match_info_win:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\insert match.png")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
...
class team_stand:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\ranking.jpg")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
...
class del_player_info_window:
    def __init__(self, root):
        ...
        original_bg1 = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\CR7.png")
        resized_bg1 = original_bg1.resize((470, 550), Image.BICUBIC)
        self.bg1 = ImageTk.PhotoImage(resized_bg1)
        left_lbl = Label(self.frame_border, image=self.bg1)
        left_lbl.place(x=10, y=10, width=470, height=550)
...
class display_TEAMS_win:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\uefa-champions-league-star-bowl-rlsrfh81jsb88ed1.jpg")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)

        ######### Resize and display the frame image #####
        original_frame_image = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\frame display.png")
...
class display_real_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\bg2321.png")
...
class display_BARCA_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\new bg.png")
        resized_bg = original_bg.resize((1400, 750), Image.BICUBIC)  # Set the desired width and height
        self.bg = ImageTk.PhotoImage(resized_bg)
...
class display_psg_win:
    def __init__(self, root):
        ...
        original_bg = Image.open(r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\bgweq21.png")
        resized_bg = original_bg.resize((1400, 750), Image.BICUBIC)  # Set the desired width and height
        self.bg = ImageTk.PhotoImage(resized_bg)
...
class display_MATCHESSSS_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\MATCHES SCH.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)
...
class display_RANK_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\STANDING.png")
        lbl_bg = Label(self.root, image=self.bg)
        lbl_bg.place(x=0, y=0, relwidth=1, relheight=1)
...
class display_playerinfo_win:
    def __init__(self, root):
        ...
        # Load background image
        self.bg = ImageTk.PhotoImage(file=r"C:\Users\Pawan Sharma\Football_management_system\football_managmnet _system\DBMS GUI PROJECT\images\PLAYER INFO.png")
        lbl_bg = Label(self.root, image=self.bg)
